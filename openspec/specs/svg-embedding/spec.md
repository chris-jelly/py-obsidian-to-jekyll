...
This capability handles the resolution and copying of SVG and Excalidraw diagram embeds, with support for multiple file naming patterns and configurable source directories.
