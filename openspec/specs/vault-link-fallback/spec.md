...
This capability provides a fallback mechanism for unresolved wikilinks, converting them to plain text and emitting warnings to help authors identify vault-only references.
